...
var app = (function () {
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const card = new Card({
    			props: {
    				cardImage: /*cocktail*/ ctx[8].imageUrl
    				? /*cocktail*/ ctx[8].imageUrl
    				: /*cardImage*/ ctx[4],
    				$$slots: {
    	...
    	card.$on("cardClick", function () {
    		if (is_function(/*handleCardClick*/ ctx[5](/*cocktail*/ ctx[8].id))) /*handleCardClick*/ ctx[5](/*cocktail*/ ctx[8].id).apply(this, arguments);
    	});
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*$cocktailsStore*/ 4) card_changes.cardImage = /*cocktail*/ ctx[8].imageUrl
    			? /*cocktail*/ ctx[8].imageUrl
    			: /*cardImage*/ ctx[4];

    			if (dirty & /*$$scope, $cocktailsStore*/ 2052) {
    ...
    // (24:8) {#if cocktail.category             && cocktail.category.find((cat) => { return cat === selectedItem; })             && (`${JSON.stringify(cocktail.recipes)}`.toUpperCase().includes($searchTextBoxStore.toUpperCase()) || cocktail.cocktailName.toUpperCase().includes($searchTextBoxStore.toUpperCase()))}
    function create_if_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(24:8) {#if cocktail.category             && cocktail.category.find((cat) => { return cat === selectedItem; })             && (`${JSON.stringify(cocktail.recipes)}`.toUpperCase().includes($searchTextBoxStore.toUpperCase()) || cocktail.cocktailName.toUpperCase().includes($searchTextBoxStore.toUpperCase()))}",
    		ctx
    	});
    ...
    // (35:16) <div slot="card-header" class="card-header">
    function create_card_header_slot_1(ctx) {
    	let div;
    	let span;
    	let t_value = /*cocktail*/ ctx[8].cocktailName + "";
    	let t;
    	let span_href_value;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*$cocktailsStore*/ 4 && t_value !== (t_value = /*cocktail*/ ctx[8].cocktailName + "")) set_data_dev(t, t_value);

    			if (dirty & /*$cocktailsStore*/ 4 && span_href_value !== (span_href_value = "#/cocktail/" + /*cocktail*/ ctx[8].id)) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(35:16) <div slot=\\\"card-header\\\" class=\\\"card-header\\\">",
    		ctx
    	});
    ...
    // (34:12) <Card cardImage={cocktail.imageUrl ? cocktail.imageUrl : cardImage} on:cardClick={handleCardClick(cocktail.id)}>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(34:12) <Card cardImage={cocktail.imageUrl ? cocktail.imageUrl : cardImage} on:cardClick={handleCardClick(cocktail.id)}>",
    		ctx
    	});
    ...
    // (28:16) <div slot="card-header" class="card-header">
    function create_card_header_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(28:16) <div slot=\\\"card-header\\\" class=\\\"card-header\\\">",
    		ctx
    	});
    ...
    // (27:12) <Card cardImage={cocktail.imageUrl ? cocktail.imageUrl : cardImage} on:cardClick={handleCardClick(cocktail.id)}>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(27:12) <Card cardImage={cocktail.imageUrl ? cocktail.imageUrl : cardImage} on:cardClick={handleCardClick(cocktail.id)}>",
    		ctx
    	});
    ...
    // (23:4) {#each $cocktailsStore as cocktail}
    function create_each_block(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (dirty & /*$cocktailsStore, selectedItem, $searchTextBoxStore*/ 14) show_if = !!(/*cocktail*/ ctx[8].category && /*cocktail*/ ctx[8].category.find(/*func*/ ctx[7]) && (`${JSON.stringify(/*cocktail*/ ctx[8].recipes)}`.toUpperCase().includes(/*$searchTextBoxStore*/ ctx[3].toUpperCase()) || /*cocktail*/ ctx[8].cocktailName.toUpperCase().includes(/*$searchTextBoxStore*/ ctx[3].toUpperCase())));
    		if (show_if) return 0;
    		if (dirty & /*selectedItem, $cocktailsStore, $searchTextBoxStore*/ 14) show_if_1 = !!(/*selectedItem*/ ctx[1] === "All" && (`${JSON.stringify(/*cocktail*/ ctx[8].recipes)}`.toUpperCase().includes(/*$searchTextBoxStore*/ ctx[3].toUpperCase()) || /*cocktail*/ ctx[8].cocktailName.toUpperCase().includes(/*$searchTextBoxStore*/ ctx[3].toUpperCase())));
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(23:4) {#each $cocktailsStore as cocktail}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*$cocktailsStore, cardImage, handleCardClick, selectedItem, JSON, $searchTextBoxStore*/ 62) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, pageStateStore, $$value => $$invalidate(6, $pageStateStore = $$value));
    	...
    	const handleCardClick = (cocktailId, event) => {
    		location.href = "#/cocktail/" + cocktailId;
    		let state = $pageStateStore;
    		pageStateStore.setState({ ...state, modalOpened: true });
    	};
    ...
    // (41:16) <div slot="card-header" class="card-header">
    function create_card_header_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(41:16) <div slot=\\\"card-header\\\" class=\\\"card-header\\\">",
    		ctx
    	});
    ...
    // (44:16) <div slot="card-body" class="card-body">
    function create_card_body_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(44:16) <div slot=\\\"card-body\\\" class=\\\"card-body\\\">",
    		ctx
    	});
    ...
    // (40:12) <Card cardImage={cocktail.imageUrl ? cocktail.imageUrl : cardImage} on:goBack={goBack} minImgHeight={"300px"} goBackBtn={"/"}>
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(40:12) <Card cardImage={cocktail.imageUrl ? cocktail.imageUrl : cardImage} on:goBack={goBack} minImgHeight={\\\"300px\\\"} goBackBtn={\\\"/\\\"}>",
    		ctx
    	});
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	let $pageStateStore;
    	validate_store(cocktailsStore, "cocktailsStore");
    	component_subscribe($$self, cocktailsStore, $$value => $$invalidate(3, $cocktailsStore = $$value));
    	validate_store(pageStateStore, "pageStateStore");
    	...
    	return [cocktail, cardImage, goBack];
    }
