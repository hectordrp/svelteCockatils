...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 21, 8, 1013);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const card_header_slot_template = /*$$slots*/ ctx[6]["card-header"];
    	const card_header_slot = create_slot(card_header_slot_template, ctx, /*$$scope*/ ctx[5], get_card_header_slot_context);
    	const card_body_slot_template = /*$$slots*/ ctx[6]["card-body"];
    	const card_body_slot = create_slot(card_body_slot_template, ctx, /*$$scope*/ ctx[5], get_card_body_slot_context);
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (card_header_slot) {
    				if (card_header_slot.p && dirty & /*$$scope*/ 32) {
    					card_header_slot.p(get_slot_context(card_header_slot_template, ctx, /*$$scope*/ ctx[5], get_card_header_slot_context), get_slot_changes(card_header_slot_template, /*$$scope*/ ctx[5], dirty, get_card_header_slot_changes));
    				}
    			}

    			if (card_body_slot) {
    				if (card_body_slot.p && dirty & /*$$scope*/ 32) {
    					card_body_slot.p(get_slot_context(card_body_slot_template, ctx, /*$$scope*/ ctx[5], get_card_body_slot_context), get_slot_changes(card_body_slot_template, /*$$scope*/ ctx[5], dirty, get_card_body_slot_changes));
    				}
    			}
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [cardImage, minImgHeight, goBackBtn, goBack, dispatch, $$scope, $$slots];
    }
    ...
    function create_card_header_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a = element("a");
    			t = text(t_value);
    			attr_dev(a, "href", a_href_value = "#/cocktail/" + /*cocktail*/ ctx[6].id);
    			attr_dev(a, "class", "svelte-gka30t");
    			add_location(a, file$1, 26, 20, 1243);
    			attr_dev(div, "slot", "card-header");
    			attr_dev(div, "class", "card-header svelte-gka30t");
    			add_location(div, file$1, 25, 16, 1177);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, a);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$cocktailsStore*/ 4 && a_href_value !== (a_href_value = "#/cocktail/" + /*cocktail*/ ctx[6].id)) {
    ...
    function create_card_header_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "href", a_href_value = "#/cocktail/" + /*cocktail*/ ctx[6].id);
    			attr_dev(a, "class", "svelte-gka30t");
    			add_location(a, file$1, 19, 20, 779);
    			attr_dev(div, "slot", "card-header");
    			attr_dev(div, "class", "card-header svelte-gka30t");
    			add_location(div, file$1, 18, 16, 713);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, a);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*cardImage, $cocktailsStore, selectedItem, JSON, $searchTextBoxStore*/ 30) {
